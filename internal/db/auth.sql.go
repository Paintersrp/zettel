...
WITH new_user AS (
    ...
    VALUES ($1, $2, $3, $4, $5, $6)
    RETURNING id, username, hashed_password, email, role_id, verification_id, bio, preferred_name, onboarding, onboarding_from, completed_tutorial, created_at, updated_at, active_vault
)
SELECT 
    new_user.id, new_user.username, new_user.hashed_password, new_user.email, new_user.role_id, new_user.verification_id, new_user.bio, new_user.preferred_name, new_user.onboarding, new_user.onboarding_from, new_user.completed_tutorial, new_user.created_at, new_user.updated_at, new_user.active_vault,
...
SELECT u.id, u.username, u.hashed_password, u.email, u.role_id, u.verification_id, u.bio, u.preferred_name, u.onboarding, u.onboarding_from, u.completed_tutorial, u.created_at, u.updated_at, u.active_vault, r.name AS role_name
FROM users u
...
SELECT 
    users.id, users.username, users.hashed_password, users.email, users.role_id, users.verification_id, users.bio, users.preferred_name, users.onboarding, users.onboarding_from, users.completed_tutorial, users.created_at, users.updated_at, users.active_vault,
    verifications.token AS verification_token,
    verifications.expires_at AS verification_expires_at,
    verifications.created_at AS verification_created_at,
    verifications.updated_at AS verification_updated_at,
...
SELECT 
    updated_user.id, updated_user.username, updated_user.hashed_password, updated_user.email, updated_user.role_id, updated_user.verification_id, updated_user.bio, updated_user.preferred_name, updated_user.onboarding, updated_user.onboarding_from, updated_user.completed_tutorial, updated_user.created_at, updated_user.updated_at, updated_user.active_vault,
    verifications.token,
