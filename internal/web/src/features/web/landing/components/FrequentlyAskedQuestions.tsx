    ...
    <section className="w-full max-w-5xl pb-12">
      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger>What is the Zettelkasten method?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            We take security seriously. All your notes are encrypted in transit
            and at rest. We use industry-standard security practices to ensure
