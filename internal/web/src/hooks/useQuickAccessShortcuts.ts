...
import { QuickAccessStore } from "@/lib/stores/quickAccess"

interface UseCommandKeyboardShortcutsProps {
...
export const useCommandKeyboardShortcuts = ({
  ...
  onSelectCreateVault,
  quickAccess,
}: UseCommandKeyboardShortcutsProps) => {
