...
import { withTooltip } from "../editor/ui/EditorTooltip"
...
const toolbarButtonVariants = cva(
  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        default:
          "bg-transparent hover:bg-primary/20 hover:text-primary text-muted-foreground aria-checked:bg-primary/30 aria-checked:text-primary",
        outline:
